...
import {
  ...
  Autocomplete, InputAdornment, Grid
} from '@mui/material'
import {
      ...
      <Card sx={{ mb: 3 }}>
        <CardContent sx={{ p: 3 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2.5 }}>
            ...
            {totalItems > 0 && (
              <Chip label={`${totalItems} records`} size="small" color="primary" sx={{ ml: 'auto' }} />
            )}
          </Box>
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} alignItems={{ sm: 'center' }} flexWrap="wrap">
            ...
            <Button variant="outlined" size="small" onClick={() => { setSearch(''); fetchHistory(1) }} startIcon={<Refresh />}>
              Reset
            </Button>
          </Stack>
        </CardContent>
